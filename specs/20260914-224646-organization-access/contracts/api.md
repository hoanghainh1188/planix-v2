...
`ACCOUNTABLE_REQUIRED`, `ALREADY_PROJECT_MEMBER`, `NOT_PROJECT_MEMBER`, `PAYLOAD_TOO_LARGE` (413 — body JSON/urlencoded
vượt 100 KB, mọi route; decision `2026-09-15-005-payload-too-large`), `INTERNAL_ERROR` (500 — lỗi không xác định, không lộ chi tiết).
