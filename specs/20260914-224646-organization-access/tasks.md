...
- [ ] T042 [P] `apps/server/src/shared/auth/rate-limit.middleware.ts`: `express-rate-limit` giới hạn theo IP cho `/api/v1/auth/*` và `/api/v1/invitations/*` → 429 `RATE_LIMITED`
